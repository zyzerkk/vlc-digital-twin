...
**Resultado esperado:** Curva predita sobreposta ao modelo analítico com erro < 0,5 dB

**Saída gerada:** `resultado_exp1_snr_pinn.png`
...
**Saída gerada:** `resultado_exp2_classificador.png`
...
**Saída gerada:** `resultado_exp3_1_digital_twin_3d.png`
