...
> Seção atualizada à medida que os experimentos são executados.
> As imagens abaixo são geradas pelos scripts em `src/` e salvas em `assets/`.

| Experimento | Métrica principal | Valor obtido |
|-------------|-------------------|--------------|
| EXP1 — PINN SNR | RMSE vs. analítico | *a preencher após rodar* |
| EXP2 — Classificador | Acurácia (teste) | *a preencher após rodar* |
| EXP3.1 — Digital Twin 3D | Loss final (MSE) | *a preencher após rodar* |
| EXP3.2 — Sombreamento | RMSE zona de sombra | *a preencher após rodar* |
| EXP3.3 — MIMO-VLC | PSNR final | *a preencher após rodar* |
